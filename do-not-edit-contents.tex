...
\textbf{Threat: Increasing knowledge silos.} When developers routinely work on one part of the code base, they can develop specific system context not shared by the team. When code specialization occurs, it can become harder for anyone on the team to modify any part of the team's code.  If the team says \participantQuote{We need Marion on that story, only she knows the Apple watch code base,} or \participantQuote{Shea knows the ins-and-outs of the legacy integration, we need him to work on this story,} then there is a hindering imbalance between the individual and team understanding of the code.
...
The team wants to feel \quotes{pride in improving code quality.}  It feels good to be improving the code design and readability. If the team starts neglecting these concerns, it can engender a sense of disgust and apathy for the code can spread throughout the team.
...
2) Meanwhile, both discussions with and observations of participants suggest five factors associated with strong feelings team code ownership. Pivotal developers more acutely feel team code ownership when 1) they understand the system context; 2) they contribute to the code in question; 3) they perceive code quality is high; 4) they perceive the product will satisfy the user needs; and 5) they perceive team cohesion is high.   
