...
\textit{Results:} A team can use pair programming, overlapping pair rotation, and continuous refactoring to promote collective code ownership. This paper examines how increasing team size, increasing product apathy, increasing team apathy, and increasing code apathy, and breakdowns in pair programming threaten a team's sense of code ownership. The creation of knowledge silos and the accruing of technical debt prevent obstacles for the team to overcome. 
